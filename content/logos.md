...
# Sherpasec Logos
<div style="display: flex; justify-content: center; background: transparent; width: 80%; padding: 10px 20px">
    <img src="/images/W_ SHERPASEC LOGO.png" alt="Sherpasec">
</div></br>
<div style="display: flex; justify-content: center; background: transparent; width: 80%; padding: 10px 20px">
    <img src="/images/B_ SHERPASEC LOGO.png" alt="Sherpasec">
</div></br>
<p>
